...
void UOverlayWidgetController::OnXPChanged(int32 NewXP) const
{
	...
	checkf(LevelUpInfo, TEXT("Unable to find LevelUpInfo. Please fill out BP_AuraPlayerState"));
	...
	if (Level <= MaxLevel && Level > 0)
	{
		...
		const int32 DeltaLevelRequirement = CurrentLevelUpRequirement - PreviousLevelUpRequirement;
